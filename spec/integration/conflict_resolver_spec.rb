...
RSpec.describe "Json::Merge::ConflictResolver Integration" do
  ...
  describe "#add_node_to_result with unknown statement type" do
    it "logs debug message for unknown statement types" do
      ...
      resolver = Json::Merge::ConflictResolver.new(template_analysis, dest_analysis)
      result = Json::Merge::MergeResult.new

      unknown_statement = Object.new

      expect {
        resolver.send(:add_node_to_result, unknown_statement, result, :destination, :kept_dest, dest_analysis)
