...
RSpec.shared_examples "valid JSON parsing" do |expected_backend:|
  describe "with valid JSON source" do
    ...
    it "returns NodeWrapper for statements" do
      analysis = described_class.new(simple_json)
      statements = analysis.statements
      expect(statements).to be_an(Array)
      expect(statements.first).to be_a(Json::Merge::NodeWrapper)
    end
...
RSpec.shared_examples "root pairs extraction" do
  describe "#root_pairs" do
    ...
    it "returns empty array when no root object (array)" do
...
RSpec.shared_examples "integrate_nodes" do
