...
# kettle-jem:freeze
# To retain chunks of comments & code during json-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# json-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

# json-merge Rakefile v1.0.0 - 2026-04-05
...
# rake install                                # Build and install json-merge-1.0.0.gem in...
# rake install:local                          # Build and install json-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install json-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template json-merge against itse...
# rake kettle:jem:template                    # Template json-merge files into the curren...
...
begin
  ...
  # Uses :ffi_backend tag - same pattern as other backends
